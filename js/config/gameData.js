...
export const GameData = {
    ...
    cards: [
        { id: 'autographed_jersey', name: 'Autographed Jersey Card', basePrice: 650, description: 'Numbered and signed featuring a piece of player-worn jersey.' },
        { id: 'numbered_rookie_auto', name: 'Numbered Rookie Auto', basePrice: 500, description: 'A numbered rookie card with a signature.' },
